...
<section>
    ...
    <form wire:submit="updateProfileInformation" class="tw-mt-6 tw-space-y-6">
            ...
            @if (auth()->user() instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! auth()->user()->hasVerifiedEmail())
                <div>
                    <p class="tw-text-sm tw-mt-2 tw-text-gray-800">
                        ...
                        <button wire:click.prevent="sendVerification" class="tw-underline tw-text-sm tw-text-gray-600 hover:tw-text-gray-900 tw-rounded-md focus:tw-outline-none focus:tw-ring-2 focus:tw-ring-offset-2 focus:tw-ring-indigo-500">
        ...
        <div class="tw-flex tw-items-center tw-gap-4">
            ...
            <x-action-message class="tw-me-3" on="profile-updated">
                {{ __('Saved.') }}
            </x-action-message>
        </div>
    </form>

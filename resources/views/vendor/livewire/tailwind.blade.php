                        ...
                        @foreach ($elements as $element)
                            ...
                            @if (is_string($element))
                                <span aria-disabled="true">
                                    <span class="tw-relative tw-inline-flex tw-items-center tw-px-4 tw-py-2 -tw-ml-px tw-text-sm tw-font-medium tw-text-gray-700 tw-bg-white tw-border tw-border-gray-300 tw-cursor-default tw-leading-5 dark:tw-bg-gray-800 dark:tw-border-gray-600 dark:tw-text-gray-300">{{ $element }}</span>
                                </span>
                            @endif
